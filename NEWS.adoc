...
https://github.com/azhao1981/tig/releases or use the following pattern:

    https://github.com/azhao1981/tig/releases/download/tig-VERSION/tig-VERSION.tar.gz

MD5 checksums can be found at:

    https://github.com/azhao1981/tig/releases/download/tig-VERSION/tig-VERSION.tar.gz.md5
...
The master repository is git://github.com/azhao1981/tig.git, and the old
